...
$GLOBALS['TL_LANG']['tl_export_table']['bom'] = ['BOM hinzufügen', 'Füge der Datei das BOM (Byte Order Mark) hinzu (Korrekte Darstellung von UTF-8 codierten Zeichen in MS-Excel).'];
